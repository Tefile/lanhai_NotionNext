...
const BLOG = {
  ...
  BIO: '一个逆向破解者', // 作者简介
  LINK: '', // 网站地址
  KEYWORDS: '墨雪的破解网站', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:process.env.NOTION_PAGE_ID || '203b76de0b294e2abf6f202937beb857', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'quequeda96@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/Tefile',
  CONTACT_TELEGRAM: '',

  // 鼠标点击烟花特效
  FIREWORKS: true, // 鼠标点击烟花特效
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '逆向小白进击之路', // 站点描述，被notion中的页面描述覆盖
